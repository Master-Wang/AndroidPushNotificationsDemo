...
public interface IMqttClient {
	public abstract void startTrace() throws MqttException;

	public abstract void stopTrace();

	public abstract MqttPersistence getPersistence();

	public abstract void registerAdvancedHandler(
			MqttAdvancedCallback mqttadvancedcallback);

	public abstract void registerSimpleHandler(
			MqttSimpleCallback mqttsimplecallback);
	...
	public abstract void connect(String s, boolean flag, short word0,
			String s1, int i, String s2, boolean flag1) throws MqttException,
			MqttPersistenceException, MqttBrokerUnavailableException,
			MqttNotConnectedException;

	public abstract void disconnect() throws MqttPersistenceException;
	...
	public abstract void ping() throws MqttException;
